...
Prepared and verified on `main` on 2026-08-21. npm publication and a GitHub release are intentionally separate release actions.
...
- Replaced duplicated legacy tests with one shared 90-case registry.
- Split verification into Unit (16), Functional (26), Integration (14), and Regression (34) suites.
...
- Added validated hot-path benchmarks and machine-readable results.
- Added a Node 22.12/24, Ubuntu/macOS/Windows CI matrix.

### Documentation

- Added a focused multi-page GitHub Pages site, live playground, live shared-suite runner, coverage reports, benchmark evidence, migration guide, and security policy.
